...
SECRET_KEY = "django-insecure-2=zwcdve=_80s+yb_mfa&!^fir#_#5=6gtyaa1vwa-_nrjpg#d"
...
MEDIA_ROOT = BASE_DIR / 'media'  # Path to the media folder where uploaded files will be stored
